...
public class MainHW2 {
    ...
    private static void classifyAndTest(DecisionTree decisionTree, Writer writer, DecisionTree.PruningMode pruningMode, Instances trainingCancer, Instances validationCancer, Instances testingCancer) throws Exception {
        ...
        if (pruningMode == DecisionTree.PruningMode.Rule) {
            decisionTree.setValidationSet(validationCancer);
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            classifyAndTest(new DecisionTree(), writer, DecisionTree.PruningMode.None, trainingCancer, validationCancer, testingCancer);

            //Decision Tree with Chi pruning
            classifyAndTest(new DecisionTree(), writer, DecisionTree.PruningMode.Chi, trainingCancer, validationCancer, testingCancer);

            //Decision Tree with Rule pruning
            classifyAndTest(new DecisionTree(), writer, DecisionTree.PruningMode.Rule, trainingCancer, validationCancer, testingCancer);
